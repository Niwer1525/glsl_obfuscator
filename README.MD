...
# Usage
![GitHub release (latest by date)](https://img.shields.io/github/v/release/Niwer1525/glsl_obfuscator?label=latest%20version&color=blue)
Or [📥Download the jar](https://github.com/Niwer1525/glsl_obfuscator/releases/latest/download/glsl-obfuscator-plugin.jar)

See on [JitPack](https://jitpack.io/#Niwer1525/glsl_obfuscator) for more versions
...
buildscript {
	...
	dependencies {
		classpath 'com.github.Niwer1525:glsl_obfuscator:v1.0.3'
	}
}
apply plugin: 'com.niwer.glsl_obfuscator'
```
By default, the plugin will minify all files in the "src/main/resources/" folder and subfolders. You can change this by adding the following code to your build.gradle file:
```groovy
glslObfuscator {
	sourceDir = 'src/main/resources/shaders' // Change this to your shaders folder
}
```
